...
import { FiDollarSign, FiUser, FiFolder, FiCreditCard, FiEdit, FiTrash2 } from "react-icons/fi";
...
return (
  <div className="p-6 bg-linear-to-b from-[#faf6ef] to-[#e8ddc9] pt-32 h-screen mx-auto">
    ...
    <form onSubmit={handleSubmit} className="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
      ...
      <input placeholder="User ID" value={form.useEffect}
      ...
      <button type="submit"
        className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition col-span-full md:col-span-2">
        ...
        {transactions.map((tx,index)=>(
          <motion.div key={tx._id} initial={{opacity:0,x:-20}} animate={{opacity:1,x:0}}
            ...
            <div className="space-y-1">
              ...
              <p className={`font-semibold ${tx.status === "completed" ? "text-green-600" : "text-yellow-600" }`}>
                Status: {tx.status}
              </p>
